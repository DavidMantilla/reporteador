            ...
            <div class="col-md-12">
                <div class="card" style="height: 95%">
                    <div class="card-header d-flex " style="justify-content: space-around; width: 100%">
                        ...
                        <div>
                            <button class="btn btn-dark" style="background: #ec0808" id="ventaspdf"><i
                                    class="fa-solid fa-file-pdf"></i></button>
                            <button class="btn btn-dark" style="background: #029b38" id="ventasExcel"><i
                                    class="fa-solid fa-file-excel"></i></button>
                        </div>
                    </div>
                    <div class="card-body">
                        <table class="table table-responsive" style="border:1px solid #000;" id="ventastable">
                            <tr>
                                <th>Fecha</th>
                                <th>Sucursal</th>
                                <th> Cliente</th>
