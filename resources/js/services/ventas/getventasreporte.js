        ...
        if (table) {
            ...
            table = new DataTable("#ventastable", {
                ...
                columns: [
                    ...
                    { data: "Importe",render:(data, type, row)=>{
                    ...
                    { data: "Impuesto",render:(data, type, row)=>{
...
async function getventasperiodo(Data) {
    ...
    if (fechaInicial != "") {
        if (fechaInicial) {
            periodo += ` ${`and (FechaDoc ge ${new Date(
                fechaInicial
...
if (formPeriodo != null) {
    ...
    fechaInicial.value = new Date(anioActual, mesActual, 1)
        .toISOString()
        .split("T")[0]; // Primer día del mes
    fechaFinal.value = new Date(anioActual, mesActual + 1, 0)
        .toISOString()
