...
let licenciamiento = `${config.OdataUrl}sucursales?$expand=licenciamientos&$filter=Id_Empresa eq ${id} and Estado eq 'ACTIVO'`;
...
if(document.getElementById("pag-sucursales")){
